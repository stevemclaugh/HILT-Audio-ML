...
Open a new terminal window. On macOS, open the application `Terminal`, located in `/Applications/Utilities`. On Windows, double click `Docker Quickstart Terminal` on your desktop.
